  ...
  (props, ref) => {
    ...
    return (
      <DropdownPrimitive.SubTrigger
        ref={ref}
        className={cn(
          'focus:bg-elements data-[state=open]:bg-elements flex cursor-default select-none items-center rounded px-2 py-1.5 text-sm outline-none',
          inset && 'pl-8',
          className,
        )}
        {...subTriggerProps}
...
>((props, ref) => {
  ...
  return (
    <DropdownPrimitive.SubContent
      ref={ref}
      className={cn(
        'bg-secondary text-popover-foreground data-[side=bottom]:animate-slide-up-fade data-[side=left]:animate-slide-right-fade data-[side=right]:animate-slide-left-fade data-[side=top]:animate-slide-down-fade min-w-[8rem] overflow-hidden rounded-md border p-1',
      ...
      <DropdownPrimitive.Portal>
        <DropdownPrimitive.Content
          ...
          className={cn(
            ...
            'border-border bg-secondary text-foreground min-w-[8rem] rounded-lg border p-1',
